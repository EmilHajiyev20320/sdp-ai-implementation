...
4. Structure: clear intro paragraph, 2–3 body paragraphs, brief conclusion.
5. Do not place URLs or citations inside article paragraphs.
6. End with a short "Sources" section listing only the URLs you used (one per line).
7. If you detect any Azerbaijani words or characters, rewrite the text in English immediately.
